...
export default {
  ...
  primary_button_fill_tap: '#06ae56',
  ...
  // keyboard
  keyboard_line_color: 'rgba(245, 245, 245, 1)',
  keyboard_text_black: 'rgba(50, 50, 50, 1)',
  keyboard_text_black_light: 'rgba(75, 75, 75, 1)',
  keyboard_text_gray: 'rgba(153, 153, 153, 1)'
}