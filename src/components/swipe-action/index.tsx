...
interface SwipeableProps
   ...
   * */
  renderLeftActions?: (// @ts-ignore
    progressAnimatedValue: Animated.AnimatedInterpolation,// @ts-ignore
...
class SwipeAction extends React.Component<SwipeActionProps> {
  ...
  renderActions = (// @ts-ignore
    progress: Animated.AnimatedInterpolation, // @ts-ignore
