...
export default (theme: Theme) =>
  StyleSheet.create<ButtonStyles>({
    ...
    ghostDisabledRaw: {
      borderColor: `${theme.color_text_base}1A`, // alpha 10%
    },
    warningDisabledRaw: {
      opacity: 0.4,
    },
    ...
    primaryHighlightText: {
      color: `${theme.color_text_base_inverse}4D`, // alpha 30%
    },
    ghostHighlightText: {
    ...
    defaultDisabledRawText: {
      color: `${theme.color_text_base}4D`, // alpha 30%
    },
    primaryDisabledRawText: {
      color: `${theme.color_text_base_inverse}99`, // alpha 60%
    },
    ghostDisabledRawText: {
      color: `${theme.color_text_base}1A`, // alpha 10%
    },
